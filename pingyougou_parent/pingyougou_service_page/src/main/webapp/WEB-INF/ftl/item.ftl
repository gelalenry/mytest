        ...
        <div class="product-info">
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <dl id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${value}')?'selected':''}}" ng-click="selectSpecification('${spec.attributeName}','${value}')" >${value}<span title="点击取消选择">&nbsp;</span>
                            </a></dd>
